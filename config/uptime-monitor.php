...
return [
    ...
    'notifications' => [
        ...
        'notifications' => [
            \App\Notifications\UptimeMonitor\UptimeCheckRecovered::class => ['telegram'],
            \App\Notifications\UptimeMonitor\UptimeCheckFailed::class => ['telegram'],
         ...
         */
        'resend_uptime_check_failed_notification_every_minutes' => env('RESEND_UPTIME_CHECK_FAILED_NOTIFICATION_EVERY_MINUTES', 60),

        'mail' => [
            'to' => ['asoradev@email.com'],
        ],
    ...
    'uptime_check' => [
         ...
         */
        'run_interval_in_minutes' => env('RUN_INTERVAL_IN_MINUTES', 5),
