...
@if ($status == \Spatie\ServerMonitor\Models\Enums\CheckStatus::SUCCESS)
...
@elseif($status == \Spatie\ServerMonitor\Models\Enums\CheckStatus::NOT_YET_CHECKED)
...
@elseif ($status == \Spatie\ServerMonitor\Models\Enums\CheckStatus::FAILED)
    <svg viewBox="0 0 20 20"
         class="w-5"
         xmlns="http://www.w3.org/2000/svg">
        <path
...
@elseif($status == \Spatie\ServerMonitor\Models\Enums\CheckStatus::WARNING)
    <svg viewBox="0 0 90 90"
         class="w-5"
         xmlns="http://www.w3.org/2000/svg">
        <path
